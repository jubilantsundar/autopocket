...
# This script packages all necessary files for Colab usage

echo "================================================"
echo "Boltz-2 SAR Iterator - Colab Package Preparation"
echo "================================================"
echo ""

# Create output directory
PACKAGE_DIR="colab_upload_files"
mkdir -p "$PACKAGE_DIR"

echo "Copying required files to $PACKAGE_DIR/..."
echo ""

# Required files
echo "✓ Copying boltz2_sar_iterator.py (REQUIRED)"
cp boltz2_sar_iterator.py "$PACKAGE_DIR/"

echo "✓ Copying visualize_results.py (for plots)"
cp visualize_results.py "$PACKAGE_DIR/"

echo "✓ Copying example_compounds.csv (sample data)"
cp example_compounds.csv "$PACKAGE_DIR/"

echo "✓ Copying Colab notebook"
cp Boltz2_SAR_Iterator_Colab.ipynb "$PACKAGE_DIR/"

echo "✓ Copying Colab setup guide"
cp COLAB_SETUP.md "$PACKAGE_DIR/"
...
echo ""
echo "NEXT STEPS:"
echo "1. Add your SAR data CSV to: $PACKAGE_DIR/"
echo "2. (Optional) Add MSA and template files"
echo "3. Read: $PACKAGE_DIR/README_FIRST.txt"
echo "4. Upload Boltz2_SAR_Iterator_Colab.ipynb to Colab"
echo ""
echo "To create a ZIP for easy upload:"
echo "  zip -r colab_files.zip $PACKAGE_DIR/"
echo ""
echo "================================================"
